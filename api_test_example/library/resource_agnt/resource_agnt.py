...
from api_test_example.library.resource_agnt.resource_2_agnt import Resource2Agent
...
class ResourceAgent:
    def __init__(self, api_client: ApiClient) -> None:
        ...
        self.resource_1 = Resource1Agent(api_client=api_client)
        self.resource_2 = Resource2Agent(api_client=api_client)
